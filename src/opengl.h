...
typedef void (*glEnableFunc)(GLenum cap);
typedef void (*glDisableFunc)(GLenum cap);
typedef void (*glClearColorFunc)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
typedef void (*glBlendFuncFunc)(GLenum sfactor, GLenum dfactor);
typedef void (*glGenBuffersFunc)(GLsizei n, GLuint *buffers);
typedef void (*glBindBufferFunc)(GLenum target, GLuint buffer);
typedef void (*glBufferDataFunc)(GLenum target, GLsizeiptr size, const GLvoid *data, GLenum usage);
...
typedef void (*glScissorFunc)(GLint x, GLint y, GLsizei width, GLsizei height);
typedef void (*glClearFunc)(GLbitfield mask);
typedef GLint (*glGetUniformLocationFunc)(GLuint program, const GLchar *name);
...
typedef void (*glUniform4fFunc)(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
typedef void (*glDrawElementsFunc)(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
typedef void (*glBindTextureFunc)(GLenum target, GLuint texture);
typedef void (*glGenTexturesFunc)(GLsizei n, GLuint *textures);
typedef void (*glDeleteTexturesFunc)(GLsizei n, const GLuint *textures);
typedef void (*glTexImage2DFunc)(GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *data);
typedef void (*glTexParameteriFunc)(GLenum target, GLenum pname, GLint param);
typedef void (*glDeleteProgramFunc)(GLuint program);
typedef void (*glDebugMessageCallbackFunc)(glDebugProc callback, void* userParam);
...
typedef void (*glBindAttribLocationFunc)(GLuint program, GLuint index, const GLchar *name);
...
typedef void (*glVertexAttribPointerFunc)(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride,	const GLvoid *pointer);
typedef void (*glVertexAttribIPointerFunc)(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
typedef void (*glUniformBlockBindingFunc)(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding);
typedef void (*glBindBufferRangeFunc)(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
typedef GLuint (*glGetUniformBlockIndexFunc)(GLuint program, const GLchar *uniformBlockName);
typedef void (*glDrawArraysFunc)(GLenum mode, GLint first, GLsizei count);
typedef void (*glCullFaceFunc)(GLenum mode);
typedef void (*glFrontFaceFunc)(GLenum mode);
typedef void (*glDepthMaskFunc)(GLboolean flag);
typedef void (*glDepthFuncFunc)(GLenum func);
typedef void (*glDepthRangeFunc)(GLclampd nearVal, GLclampd farVal);
typedef void (*glClearDepthFunc)(GLclampd depth);
typedef void (*glBufferSubDataFunc)(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data);

extern glGetStringFunc glGetString;
...
extern glDebugMessageCallbackFunc glDebugMessageCallback;
...
extern glCullFaceFunc glCullFace;
extern glFrontFaceFunc glFrontFace;
extern glDepthMaskFunc glDepthMask;
extern glDepthFuncFunc glDepthFunc;
extern glDepthRangeFunc glDepthRange;
